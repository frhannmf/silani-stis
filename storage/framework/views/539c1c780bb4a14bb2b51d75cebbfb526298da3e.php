...
<?php $__env->startSection('title', 'Admin Dashboard - SILANI STIS'); ?>
    ...
    <div class="col-12 col-md">
      <div class="card card-body h-100">
        <div class="d-flex flex-column justify-content-between align-items-center h-100 gap-3">
          ...
          <a href="<?php echo e(route('admin_form_list')); ?>" class="btn btn-primary w-100">Buka Manajemen Layanan</a>
        </div>
      </div>
    </div>
    <div class="col-12 col-md">
      <div class="card card-body h-100">
        <div class="d-flex flex-column justify-content-between align-items-center h-100 gap-3">
          ...
          <a href="<?php echo e(route('admin_user_list')); ?>" class="btn btn-primary w-100">Buka Manajemen Pengguna</a>
        </div>
      </div>
    </div>
    <div class="col-12 col-md">
      <div class="card card-body h-100">
        <div class="d-flex flex-column justify-content-between align-items-center h-100 gap-3">
          ...
          <a href="<?php echo e(route('forgot_list')); ?>" class="btn btn-primary w-100">Buka Manajemen Lupa Identitas</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="card card-body" style="width: min-content;">
      <div class="d-flex flex-column justify-content-between align-items-center gap-3">
        ...
        <div class="d-flex gap-2">
          <a href="<?php echo e(route('logout')); ?>" class="btn btn-danger flex-grow-1">Keluar</a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH STIS\SEMESTER 5\RPL\SILANI STIS\project_rpl\resources\views/admin/index.blade.php ENDPATH**/ ?>