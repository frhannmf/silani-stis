...
<?php $__env->startSection('title', 'Edit Profil - SILANI STIS'); ?>
    ...
    <div class="col-md-6 offset-md-3">
      <div class="card">
        <div class="card-body">
          ...
          <form method="POST" action="<?php echo e(route('handle_edit_profile', ['id' => $user['id']])); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
              <label for="nim" class="form-label">NIM</label>
              <input type="text" class="form-control" id="nim" name="nim" value="<?php echo e($user['nim']); ?>" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender" id="gendermale" value="Laki-Laki" required <?php echo e($user['gender'] == 'Laki-Laki'?'checked':''); ?>>
            ...
            <div class="mb-4">
              ...
              <input type="text" class="form-control" id="ttl" name="ttl" value="<?php echo e($user['ttl']); ?>" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
              ...
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="status" id="status1" value="ALUMNI" required <?php echo e($user['status'] == 'ALUMNI'?'checked':''); ?>>
            ...
            <div class="mb-4">
              ...
              <input type="text" class="form-control" id="tahunlulus" name="tahun_lulus" value="<?php echo e($user['tahun_lulus']); ?>" required>
            </div>
            <div class="d-flex justify-content-between align-items-center gap-2">
              <button type="submit" class="btn btn-primary flex-grow-1">Ubah Profil</button>
              <a href="<?php echo e(route('user_dashboard')); ?>" type="button" class="btn btn-dark flex-grow-1">Kembali</a>
            </div>
          </form>
        </div>
      </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH STIS\SEMESTER 5\RPL\SILANI STIS\project_rpl\resources\views/user/profile.blade.php ENDPATH**/ ?>