...
<?php $__env->startSection('title', 'Form Pengumpulan Ijazah SMA - SILANI STIS'); ?>
    ...
    <div class="col-md-6 offset-md-3">
      <div class="card">
        <div class="card-body">
          ...
          <form method="POST" action="<?php echo e(route('handle_submit_sma')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH STIS\SEMESTER 5\RPL\SILANI STIS\project_rpl\resources\views/user/forms/submit_sma.blade.php ENDPATH**/ ?>