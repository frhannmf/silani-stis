...
<?php $__env->startSection('title', 'Dashboard - SILANI STIS'); ?>
        ...
        <div class="card card-body h-100">
          <div class="h-100 d-flex flex-column justify-content-between">
            ...
            <div class="d-flex gap-3">
              <a href="<?php echo e(route('edit_profile')); ?>" class="btn btn-primary flex-grow-1">Ubah Profil</a>
              <a href="<?php echo e(route('change_password')); ?>" class="btn btn-warning flex-grow-1">Ubah Password</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md">
        <div class="card card-body h-100">
          <div class="d-flex flex-column justify-content-between align-items-center h-100 gap-2">
            ...
            <a href="<?php echo e(route('submit_sma')); ?>" class="btn btn-primary w-100">Ajukan</a>
          </div>
        </div>
      </div>
      <div class="col-12 col-md">
        <div class="card card-body h-100">
          <div class="d-flex flex-column justify-content-between align-items-center h-100 gap-2">
            ...
            <a href="<?php echo e(route('retrieve_sma')); ?>" class="btn btn-primary w-100">Ajukan</a>
          </div>
        </div>
      </div>
      <div class="col-12 col-md">
        <div class="card card-body h-100">
          <div class="d-flex flex-column justify-content-between align-items-center h-100 gap-2">
            ...
            <a href="<?php echo e(route('retrieve_stis')); ?>" class="btn btn-primary w-100">Ajukan</a>
          </div>
        </div>
      </div>
      <div class="col-12 col-md">
        <div class="card card-body h-100">
          <div class="d-flex flex-column justify-content-between align-items-center h-100 gap-2">
            ...
            <a href="<?php echo e(route('request_sk_alumni_stis')); ?>" class="btn btn-primary w-100">Ajukan</a>
          </div>
        </div>
      </div>
      <div class="col-12 col-md">
        <div class="card card-body h-100">
          <div class="d-flex flex-column justify-content-between align-items-center h-100 gap-2">
            ...
            <a href="<?php echo e(route('request_surat_pddikti')); ?>" class="btn btn-primary w-100">Ajukan</a>
          </div>
        </div>
      </div>
    </div>
    <div class="mt-4 d-flex justify-content-center">
      <a href="<?php echo e(route('list_form')); ?>" class="btn btn-success btn-lg">Lihat Daftar Pengajuan</a>
    </div>
    <?php else: ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH STIS\SEMESTER 5\RPL\SILANI STIS\project_rpl\resources\views/user/index.blade.php ENDPATH**/ ?>